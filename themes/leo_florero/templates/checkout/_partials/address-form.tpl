...
{block name='form_fields' append}
  ...
  {if $type === "delivery"}
    <div class="form-group row">
      <div class="col-md-9 col-md-offset-3 check_box_address_step">
        <input class="check_box_address" id="use_same_address" name = "use_same_address" type = "checkbox" value = "1" {if $use_same_address} checked {/if}>
