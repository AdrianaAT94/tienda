        ...
        <div class="col-lg-6 col-md-6 total-products">
            {block name='leo_gird_list'}
                <div class="display hidden-sm-down">
                    <div id="grid" class="selected leo_grid {if isset($LISTING_GRID_MODE) && $LISTING_GRID_MODE =='grid'}selected{/if}"><a rel="nofollow" href="#" title="{l s='Grid' d='Shop.Theme.Global'}"><i class="fa fa-th"></i></a></div>
