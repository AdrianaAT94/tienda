...
<div id="leo-paneltool" class="hidden-md-down" data-cname="{$LEO_COOKIE_THEME}">
	{if isset($list_productdetail_layout) &&  count($list_productdetail_layout) > 1}
		...
		<div class="panelcontent block-multiproductdetailtool">
			<div class="panelinner">
				<div class="group-input row layout">
					<label class="col-sm-12 control-label"><span class="fa fa-desktop"></span>{l s='Product Multi Layout' d='Shop.Theme.Global'}</label>
					<div class="col-sm-12">
						{foreach $list_productdetail_layout as $list_productdetail_layout_item}        
						<a class="product-detail-demo{if isset($product.productLayout) && $product.productLayout != '' && $product.productLayout == $list_productdetail_layout_item['plist_key']} active{/if}" data-product-detail-key={$list_productdetail_layout_item['plist_key']} href="{$list_productdetail_layout_item['product_layout_link']}">
							<span>{$list_productdetail_layout_item['name']}</span>
